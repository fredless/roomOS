...
from xapi_common import resolve_device_id, resolve_token, ssh_run_xcommands, xapi_status
...
def main() -> int:
    """list ethernet microphone inputs on a RoomOS codec (local SSH or cloud xAPI)"""
